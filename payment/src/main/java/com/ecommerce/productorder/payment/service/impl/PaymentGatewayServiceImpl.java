...
public class PaymentGatewayServiceImpl implements PaymentGatewayService {
  ...
  public PaymentResponse processPayment(Payment payment, ProcessPaymentRequest request) {
    ...
    try {
      ...
      log.error(
          "Error processing payment through gateway for payment ID: {}", payment.getPaymentId(), e);
  ...
  public PaymentResponse processRefund(Payment payment, BigDecimal refundAmount) {
    ...
    try {
      ...
      log.error(
          "Error processing refund through gateway for payment ID: {}", payment.getPaymentId(), e);
      return createFailedResponse(payment, "Gateway communication error: " + e.getMessage());
    }
  }
  ...
  public List<String> getSupportedPaymentMethods() {
    return Arrays.asList("CREDIT_CARD", "DEBIT_CARD", "PAYPAL", "STRIPE");
  }
  ...
  // Simulates processing delay, network latency and processing time
