...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse updateProduct(Long productId, UpdateProductRequest request) {
        ...
        // Business rule: Check SKU uniqueness if SKU is being updated
    ...
    @Override
    // @Cacheable(value = "products", key = "#productId") // Temporarily disabled due to Redis serialization issues
    ...
    @Override
    // @Cacheable(value = "products", key = "'sku:' + #sku") // Temporarily disabled due to Redis serialization issues
    @Transactional(readOnly = true)
    ...
    @Override
    // @Cacheable(value = "products", key = "'all:' + #pageable.pageNumber + ':' + #pageable.pageSize") // Temporarily disabled due to Redis serialization issues
    @Transactional(readOnly = true)
