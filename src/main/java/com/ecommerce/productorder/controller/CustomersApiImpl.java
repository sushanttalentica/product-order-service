...
public class CustomersApiImpl implements CustomersApi {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.CustomerResponse> createCustomer(RegisterRequest registerRequest) {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.CustomerResponse> getCustomerById(Long id) {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.CustomerResponse> updateCustomer(
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.CustomerResponse> getCustomerByUsername(String username) {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.CustomerResponse> activateCustomer(Long id) {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.CustomerResponse> deactivateCustomer(Long id) {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.CustomerResponse> verifyCustomerEmail(Long id) {
