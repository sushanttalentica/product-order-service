...
public class OrdersApiImpl implements OrdersApi {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.OrderResponse> createOrder(CreateOrderRequest createOrderRequest) {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.OrderResponse> getOrderById(Long orderId) {
    ...
    @Override
    public ResponseEntity<com.ecommerce.productorder.api.model.OrderResponse> updateOrderStatus(Long orderId, String status) {
