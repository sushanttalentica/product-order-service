...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:product-order-service-group}")
    ...
    /**
     * Kafka Producer Factory for Object messages
     */
    @Bean
    ...
    /**
     * Kafka Template for Object messages (for NotificationService)
     */
    @Bean
