...
public class CustomerMapper {
    ...
    public Customer createUpdatedCustomer(Customer existingCustomer, UpdateCustomerRequest request) {
        ...
        updatedCustomer.setPassword(request.getPassword() != null && !request.getPassword().trim().isEmpty() 
            ? request.getPassword() : existingCustomer.getPassword());
        updatedCustomer.setEmail(request.getEmail() != null && !request.getEmail().trim().isEmpty() 
            ? request.getEmail() : existingCustomer.getEmail());
        updatedCustomer.setFirstName(request.getFirstName() != null && !request.getFirstName().trim().isEmpty() 
            ? request.getFirstName() : existingCustomer.getFirstName());
        updatedCustomer.setLastName(request.getLastName() != null && !request.getLastName().trim().isEmpty() 
            ? request.getLastName() : existingCustomer.getLastName());
        updatedCustomer.setPhoneNumber(request.getPhoneNumber() != null 
            ? request.getPhoneNumber() : existingCustomer.getPhoneNumber());
        updatedCustomer.setAddress(request.getAddress() != null 
    ...
    private Customer.Address createUpdatedAddress(Customer.Address existingAddress, UpdateCustomerRequest.AddressDto requestAddress) {
        ...
        address.setStreetAddress(requestAddress.getStreetAddress() != null 
            ? requestAddress.getStreetAddress() : baseAddress.getStreetAddress());
        address.setCity(requestAddress.getCity() != null 
            ? requestAddress.getCity() : baseAddress.getCity());
        address.setState(requestAddress.getState() != null 
            ? requestAddress.getState() : baseAddress.getState());
        address.setPostalCode(requestAddress.getPostalCode() != null 
            ? requestAddress.getPostalCode() : baseAddress.getPostalCode());
        address.setCountry(requestAddress.getCountry() != null 
            ? requestAddress.getCountry() : baseAddress.getCountry());
        return address;
    }
