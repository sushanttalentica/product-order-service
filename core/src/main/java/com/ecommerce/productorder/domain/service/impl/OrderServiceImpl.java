...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderServiceImpl(OrderRepository orderRepository, ProductRepository productRepository, ProductService productService, OrderMapper orderMapper, OrderEventPublisher orderEventPublisher) {
    ...
    public List<OrderResponse> getOrdersNeedingAttention() {
        ...
        // As this project is for my personal practice, returning orders that are pending for more than 24 hours
