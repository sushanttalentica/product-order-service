...
public interface NotificationService {
    ...
    boolean notifyOrderStatusUpdate(Order order, String previousStatus, Set<NotificationChannel> channels);
    
    boolean notifyOrderCancellation(Order order, Set<NotificationChannel> channels);
    
    boolean notifyPaymentConfirmation(Order order, String paymentId, Set<NotificationChannel> channels);
    
    boolean notifyInvoice(Order order, String invoiceUrl, Set<NotificationChannel> channels);
    
    boolean notifyLowStockAlert(String productName, Integer currentStock, Integer threshold, Set<NotificationChannel> channels);
